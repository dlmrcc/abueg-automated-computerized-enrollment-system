//ito yung idadagdag mo na class ito yung maghahandle ng printing
...
class Printing
{
    ...
    public Printing(DataGridView aDataGridView, PrintDocument aPrintDocument, bool CenterOnPage, bool WithTitle, string aTitleText, Font aTitleFont, Color aTitleColor, bool WithPaging)
    {
    ...
    private void DrawHeader(Graphics g)
    {
        ...
        if (IsWithPaging)
        {
            ...
            do
            {
                ...
                Font PageStringFont = new Font("Courier New", 20, FontStyle.Regular, GraphicsUnit.Point);
                ...
                g.DrawString(PageString, PageStringFont, new SolidBrush(Color.White), PageStringRectangle, PageStringFormat);
